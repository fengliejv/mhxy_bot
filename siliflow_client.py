...
def siliconflow_chat_completions(  # 调用 SiliconFlow 的 /chat/completions 接口
    ...
    base_url =  os.getenv("SILICONFLOW_BASE_URL", "https://api.siliconflow.cn/v1").rstrip("/")  # 读取/覆盖 base_url
...
def siliconflow_paddleocr(  # 用 PaddleOCR-VL 作为多模态 OCR：输入图片，输出文本
    ...
    model = os.getenv("SILICONFLOW_OCR_MODEL", "PaddlePaddle/PaddleOCR-VL-1.5")  # 选择 OCR 模型
